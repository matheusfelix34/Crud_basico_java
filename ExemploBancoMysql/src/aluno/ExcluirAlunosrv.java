...
/**
 * Servlet implementation class ExcluirAlunosrv
 */
@WebServlet("/ExcluirAlunosrv")
public class ExcluirAlunosrv extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ExcluirAlunosrv() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
			...
			String excluir;
			excluir = "delete from aluno.usuario where codigo = "+ codigo;
			//statement.execute(consulta);
			
			// executa um select
		    int rs = statement.executeUpdate(excluir);
